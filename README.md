# onMark - a useful markdown editor
## About
onMark is a cross-platform markdown editor letting you write and edit files with real-time markdown preview
...
- [ ] zoom
- [ ] themes
- [ ] **Accessibility options**, settings/preferences <- this is a point where i consider switching the project to beta
